<template>
  ...
  <DmsMemberDetails v-if="singleKnownRole === Role.DataManagementOffice" />
</template>
...
const ResearcherDetails = defineAsyncComponent(() => import('./ResearcherDetails.vue'))
...
const DmsMemberDetails = defineAsyncComponent(() => import('./DmsMemberDetails.vue'))
